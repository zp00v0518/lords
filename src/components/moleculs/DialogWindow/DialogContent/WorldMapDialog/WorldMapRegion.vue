<template>
  <div class="worldmap-region">
    <div class="worldmap-region__title">
      <div class="worldmap-region__title--txt">{{ upperFirstSymbol(headerTxt) }}</div>
...
import RegionMap from '../../../Scenes/RegionMap/RegionMap.vue'
...
export default {
  ...
  computed: {
    ...
    haveSources() {
      ...
      const storage =
        currentSector.town && currentSector.town.storage && currentSector.town.storage.sources
