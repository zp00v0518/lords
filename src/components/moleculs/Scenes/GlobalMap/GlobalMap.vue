<template>
  <div class="globalmap">
    <Tooltip
      v-show="showTooltip && !popupTown.show"
...
import PopupTown from './modules/PopupTown.vue';
import GoTo from './modules/GoTo.vue';
...
export default {
  ...
  methods: {
    ...
    getMoveBtnPositions() {
      ...
      coords = addPXToCoords(
        algebra.getPointOnStraight(right.x, right.y, bottom.x, bottom.y, '50%'),
      );
